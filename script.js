...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sahabat", "aku ada pertanyaan nih buat kamu", "question").then(function () {
      ...
      Swal.fire("Awas aja kalau kamu bohong", "", "error").then(function () {
        ...
        const {
          ...
          inputValidator: (value) => {
            if (!value) {
              return 'Isi dulu dong jangan manja'
            } else {
              nama = value;
            }
          }
          ...
          const pertanyaan = Swal.fire({
            ...
            if (result.isConfirmed) {
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        Swal.fire('yahhh , emang ga kangen sama sahabat sendiri huhuhu', '', 'error').then(function () {
                          Swal.fire('Yaudah deh okee sahabatku :((')
                        })
                      }
                    })
                  })
              ...
              Swal.fire(`Yakin ga suka sama ${sender}?`, '', 'error').then(function () {
                Swal.fire('Yaudah dehh okee sahabat huhuhu :((')
              })
            }
          })
        })
